...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = os.path.join(os.path.dirname(__file__), "regal-box-444215-q9-06a385d9825c.json")
...
if __name__ == "__main__":
  ...
  bot_app.launch(server_name="0.0.0.0", server_port=8080)
